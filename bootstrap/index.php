...
<?php if(isset($flash)) { ?>
  <div class="alert alert-success col-xs-12 col-sm-4 col-lg-4 col-sm-offset-4 col-lg-offset-4">
    <strong>Opération effectuée</strong> <?= $flash; ?>
  </div>
<?php } elseif (isset($errorFlash)) { ?>
  <div class="alert alert-danger col-xs-12 col-sm-4 col-lg-4 col-sm-offset-4 col-lg-offset-4">
